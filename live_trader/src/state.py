...
FEATURE_FIELDS = [
    ...
    # How the recent buying arrived: the share of the last five minutes'
    # transactions that landed in same-block bursts, and how many there were.
    "slot_dense_share", "sig_n5m",
